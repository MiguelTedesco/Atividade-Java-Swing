...
public class Conexao {
  ...
  public Conexao(String nomeServidor, String portaServidor, String nomeUsuario, String senha, String nomeBanco) {
    this.nomeServidor = nomeServidor;
    this.portaServidor = portaServidor;
    this.nomeUsuario = nomeUsuario;
    this.senha = senha;
    this.nomeBanco = nomeBanco;
    this.url = "jdbc:mysql://"+nomeServidor+":"+portaServidor+"/"+nomeBanco+"?autoReconnect=true&useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";
  }
